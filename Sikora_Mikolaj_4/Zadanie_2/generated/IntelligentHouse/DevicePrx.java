...
{
    default WorkingState getState()
    {
        return getState(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default WorkingState getState(java.util.Map<String, String> context)
    {
        return _iceI_getStateAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<WorkingState> getStateAsync()
    {
        return _iceI_getStateAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<WorkingState> getStateAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<WorkingState> _iceI_getStateAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<WorkingState> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getState", null, sync, null);
    ...
    default void changeWorkingState()
    {
        changeWorkingState(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void changeWorkingState(java.util.Map<String, String> context)
    {
        _iceI_changeWorkingStateAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> changeWorkingStateAsync()
    {
        return _iceI_changeWorkingStateAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> changeWorkingStateAsync(java.util.Map<String, String> context)
    {
        return _iceI_changeWorkingStateAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_changeWorkingStateAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "changeWorkingState", null, sync, null);
